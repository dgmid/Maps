//note(@duncanmid): Maps - Coda 2 Sidebar Plugin v.1.1 | © D.G. Midwinter, @duncanmid

//done(@duncanmid): get online status

online = window.navigator.onLine;



//done(@duncanmid): map vars
...
//done(@duncanmid): colorslider array
...
function initialize() {
	...
	//note(@duncanmid): update map center
	...
	//note(@duncanmid): update map zoom controls
	...
	//note(@duncanmid): update map type controls
...
//done(@duncanmid): init map if online
...
//done(@duncanmid): layout - main position bases on header height
...
//done(@duncanmid): toggle disabled state
...
$(document).ready(function() {
	...
	//done(@duncanmid): submit address on enter
	...
	//done(@duncanmid): toggle sections
	...
	//done(@duncanmid): toggle optional controls
	...
	//note(@duncanmid): controls
	
	
	
	//done(@duncanmid): lat / lng inputs
	...
	//done(@duncanmid): map type control
	...
	//done(@duncanmid): show map type control
	...
	//done(@duncanmid): map type control options
	...
	//done(@duncanmid): show zoom control
	...
	//done(@duncanmid): zoom control options
	...
	$('#center-on-marker').click(function() {
		...
		if(online) {
			...
			//note(@duncanmid): if online, center the map on the marker
			lat = $('#marker-lat').val();
			lng = $('#marker-lng').val();
			...
			//note(@duncanmid): if offline, center on the current map center
			lat = $('#map-lat').val();
			lng = $('#map-lng').val();
	...
	//done(@duncanmid): show marker stroke
	...
	//done(@duncanmid): show info window
	...
	//done(@duncanmid): add info window
	...
	function addInfoWindow() {
		...
		if(online) {
			...
			//note(@duncanmid): info window marker click listener
			...
			//note(@duncanmid): info window close listener
			(function (w) {
	...
	//done(@duncanmid): update info window content
	...
	//done(@duncanmid): update info window function
	...
	//done(@duncanmid): show streetview control
	...
	//done(@duncanmid): streetview control options
	...
	//done(@duncanmid): disable mouse scroll
	...
	//note(@duncanmid): map layers
	
	//done(@duncanmid): traffic layer
	...
	//done(@duncanmid): bicycling layer
	...
	//done(@duncanmid): update map styles
	...
	function updateMapStyles() {
		...
		//note(@duncanmid): points of interest
		if($('#poi').is(':checked')) {
